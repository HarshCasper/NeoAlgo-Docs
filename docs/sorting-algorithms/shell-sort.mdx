...
- [Aniket Singh](https://github.com/aniketsingh98571) for the [C++ implementation](https://github.com/TesseractCoding/NeoAlgo/blob/master/C-Plus-Plus/sort/Shellsort.cpp)