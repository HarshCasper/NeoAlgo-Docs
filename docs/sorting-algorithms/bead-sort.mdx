...
if __name__ == "__main__":
    a=[]
    n = int(input("Enter the elements to be sorted :"))
    for i in range(0, n):
    ele = int(input())
...
- [A N U S H](https://github.com/anushkrishnav) contributed the [Python implementation](https://github.com/TesseractCoding/NeoAlgo/blob/master/Python/sort/Bead_Sort.py)
