...
i.e; it is an integer sorting algorithm. It operates by counting the number of objects that have each distinct 
key value, and using arithmetic on those counts to determine the positions of each key value in the output sequence.
*/

#include <stdio.h>  

// function for perfroming sorting
...
* [Japneet Kaur Bhatia](https://github.com/japneetbhatia) for the [C implementation](https://github.com/TesseractCoding/NeoAlgo/blob/master/C/sort/countingSort.c)