...
-   [Adithya kurien Peter](https://github.com/aaadddiii) for the [implementation in Java](https://github.com/TesseractCoding/NeoAlgo/blob/master/Java/dp/Painting_fence.java)