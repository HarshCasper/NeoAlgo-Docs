...
-   [Nanda Kishor M Pai](https://github.com/nandakishormpai2001) for the [implementation in C++](https://github.com/TesseractCoding/NeoAlgo/blob/master/Python/cp/Paint_Fence.py)
