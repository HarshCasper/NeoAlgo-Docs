...
-   [MayureeS](https://github.com/MayureeS) for the [implementation in C++](https://github.com/TesseractCoding/NeoAlgo/blob/master/C-Plus-Plus/math/matrix_transpose.cpp)
-   [Adithya Kurien Peter](https://github.com/aaadddiii) for the [implementation in Python](https://github.com/TesseractCoding/NeoAlgo/blob/master/Python/math/Matrix_transpose.py)
