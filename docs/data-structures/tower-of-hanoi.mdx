...
* If the number of disc is 1, then simply move from source to destination.
...
// for performing the shifting operation
...
- [Sangeeta Mishra](https://github.com/SangeetaMishra) contributed the [C implementation](https://github.com/TesseractCoding/NeoAlgo/blob/master/C/other/Tower_Of_Hanoi.c)