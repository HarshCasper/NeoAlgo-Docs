...
In this we are given three towers. Tower 1 has n disks placed one over the other in ascending order such that the smallest disk is at the top of Tower 1 similar to cone shape, where n is any positive number. Tower 2 and Tower 3 are empty. We have to move all discs from Tower 1 to Tower 3 using Tower 2.
...
#### Properties:
```
If there are n number of discs, then we require atleast 2 raise to power n minus 1 moves.
