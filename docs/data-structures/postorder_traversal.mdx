...
* Right means traverse the whole right subtree in this <span class="x x-first x-last">```</span>left<span class="x x-first x-last"> -&gt; </span>right<span class="x x-first x-last"> -&gt; </span>root<span class="x x-first x-last">```</span> order until we get null.
