...
<p align="center">
  <img src="https://i.postimg.cc/zfFFTKC3/bst.png"></img>
</p>

The above diagram is an example of a binary search tree. The `root` node is `30`. The left sub-tree of the root node consists of nodes `15`, `7`,`17`, `22`,`27`. All these nodes are **lesser** than the root node. The right sub-tree of the root node consists of nodes `60`, `45` and `75` which are **greater** than the root node. Each of the sub-trees recursively obeys the binary search tree constraint. Here `7`,`17`,`27`,`45` and `75` are the leaf nodes as these nodes do not have **left subtree** or **right subtree**.
