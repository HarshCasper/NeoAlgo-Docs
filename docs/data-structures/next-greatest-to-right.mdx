...
slug: /data-structures/next-greatest-to-right
---

## Introduction

Stack as a data structure has many applications,especially because of its 'Last In, First Out' principle. One of them is to find the greatest element to the right of each element in the array. 
