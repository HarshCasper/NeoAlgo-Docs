...
Caesar cipher is one of the earliest known ciphers. It is also known as shift cipher. It is a simple substitution cipher
in which each letter of the given plaintext is **shifted** down by a certain fixed number of places known as _shift_.
