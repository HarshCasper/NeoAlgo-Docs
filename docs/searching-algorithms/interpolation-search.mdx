...
## Credits 
- [Sharvari Raut](https://github.com/sharur7) for the [Python Implementation](https://github.com/TesseractCoding/NeoAlgo/blob/master/Python/search/Interpolation_Search.py)
- [Sharvari Raut](https://github.com/sharur7) for the [C++ Implementation](https://github.com/TesseractCoding/NeoAlgo/blob/master/C-Plus-Plus/search/Interpolation_Search.cpp)
